...
async def initiatief_aanmaken(
    ...
    try:
        initiative = Initiative(
            ...
            team=data.team,
            potentie=data.potentie,
            capaciteitsvraag=data.capaciteitsvraag,
            risico=data.risico,
            bron_initiatief=data.bron_initiatief,
            externe_partners=data.externe_partners,
            betrokkenheid_iv=data.betrokkenheid_iv,
            gerelateerde_initiatieven=data.gerelateerde_initiatieven,
            volgende_stap=data.volgende_stap,
...
async def initiatief_json(
    ...
    return {
        ...
        "afdeling": initiative.afdeling,
        "team": initiative.team,
        "potentie": initiative.potentie,
        "capaciteitsvraag": initiative.capaciteitsvraag,
        "risico": initiative.risico,
        "bron_initiatief": initiative.bron_initiatief,
        "externe_partners": initiative.externe_partners,
        "betrokkenheid_iv": initiative.betrokkenheid_iv,
        "gerelateerde_initiatieven": initiative.gerelateerde_initiatieven,
        "volgende_stap": initiative.volgende_stap,
        "opmerkingen": initiative.opmerkingen,
